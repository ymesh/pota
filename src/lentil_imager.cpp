...
// NOTE: Arnold 7.3.1.0 API changes:
...
// https://help.autodesk.com/view/ARNOL/ENU/?guid=arnold_dev_guide_plugins_imagers_html
...
#else
// Arnold > 70301 Imager shader

AI_IMAGER_NODE_EXPORT_METHODS(LentilImagerMtd);
